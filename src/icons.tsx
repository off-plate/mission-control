...
export const Wallet = make(<><path d="M4 7.5C4 6.11929 5.11929 5 6.5 5H16C17.1046 5 18 5.89543 18 7V7.5" /><path d="M4 7.5V17C4 18.1046 4.89543 19 6 19H18C19.1046 19 20 18.1046 20 17V10C20 8.89543 19.1046 8 18 8H6C4.89543 8 4 8.89543 4 10V7.5Z" /><circle cx="16.25" cy="13.5" r="1" fill="currentColor" stroke="none" /></>, 16, { k: 1.2312, x: -2.775, y: -2.775 })
/* hicon: rotate-acw */
