/* Czech name days (jmeniny), month-day to the names celebrated.
   From namedays-cs 2.0.1 by Roman Ožana, MIT licence:
   https://github.com/OzzyCzech/namedays-cs
   Holidays that sit in the same list (Hromnice) are left out. */
