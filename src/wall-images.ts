...
export interface WallImage {
  ...
  w: number
  h: number
  /** True when the photograph is wide enough to earn two grid
   *  columns. Squeezed into one it reads as a strip. */
  wide: boolean
...
export const WALL_IMAGES: Record<string, WallImage> = {
  "amg-gtr": {
    ...
    srcset: "wall/amg-gtr-600.webp 600w, wall/amg-gtr-900.webp 900w, wall/amg-gtr-1400.webp 1400w, wall/amg-gtr-1800.webp 1800w",
    w: 1800, h: 1125,
    wide: true,
  ...
  "aventador-sv": {
    ...
    srcset: "wall/aventador-sv-600.webp 600w, wall/aventador-sv-900.webp 900w, wall/aventador-sv-1400.webp 1400w, wall/aventador-sv-1800.webp 1800w",
    w: 1800, h: 1200,
    wide: true,
  ...
  "gle63s": {
    src: 'wall/gle63s-1800.webp',
    srcset: "wall/gle63s-600.webp 600w, wall/gle63s-900.webp 900w, wall/gle63s-1400.webp 1400w, wall/gle63s-1800.webp 1800w",
    w: 1800, h: 1200,
    wide: true,
  ...
  "late-desk": {
    src: 'wall/late-desk-1800.webp',
    srcset: "wall/late-desk-600.webp 600w, wall/late-desk-900.webp 900w, wall/late-desk-1400.webp 1400w, wall/late-desk-1800.webp 1800w",
    w: 1800, h: 1350,
    wide: true,
  ...
  "one-light": {
    src: 'wall/one-light-1800.webp',
    srcset: "wall/one-light-600.webp 600w, wall/one-light-900.webp 900w, wall/one-light-1400.webp 1400w, wall/one-light-1800.webp 1800w",
    w: 1800, h: 1200,
    wide: true,
  ...
  "villa": {
    ...
    srcset: "wall/villa-600.webp 600w, wall/villa-900.webp 900w, wall/villa-1400.webp 1400w, wall/villa-1800.webp 1800w",
    w: 1800, h: 1125,
    wide: true,
